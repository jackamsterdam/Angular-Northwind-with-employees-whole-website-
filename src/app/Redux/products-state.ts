...
//Products Action Creators - function for creating ProudctsAction objeects. each function crates on Action object:
...
export function udpateProductAction(product: ProductModel):ProductsAction {
...
//the new ProductsState() is a default valuue for the first time only 
